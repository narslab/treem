...
library(geosphere) 
#read files
df = read.csv("ttr. heavyraillocation1903.csv",header = TRUE, na.strings =0)
...
write.csv(x=results.dfo, file="heavyrailorange_distances_1903.csv")
...
write.csv(x=results.dfr, file="heavyrailred_distances_1903.csv")
...
write.csv(x=results.dfb, file="heavyrailblue_distances_1903.csv")
